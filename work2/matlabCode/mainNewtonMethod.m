% Optimization Techniques - Work 2 - mainNewtonMethod.
% Author: Aristeidis Daskalopoulos (AEM: 10640)
% info: This script solves task 3 (Newton Method) of the work 2.
...
fprintf(' --> Starting Task3: Newton Method\n');
...
for i = 1:1:size(x0_list, 2)
    ...
    stepRule = 'constant';
    gamma = 0.5;
    figure('Name', sprintf('Newton Method Running for: x_0 = %0.2f, y_0 = %0.2f', x0(1), x0(2)));
    % Call the method with the constant gamma rule:
    displayMethodResults('Newton Method', @newtonMethod, ...
...
fprintf(' --> End Task3: Newton Method\n\n');
